...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.button1 = CTk.CTkButton(self, text="openimage", command=input)
        ...
        self.button3 = CTk.CTkButton(self, text="apply filter", command=filter)
        self.button3.grid(row=1, column=0, sticky="s", padx=5, pady=5)
        self.entryX2 = CTk.CTkEntry(self, placeholder_text="X image")
        self.entryX2.grid(row=0, column=2, sticky="s", padx=5, pady=5)
        self.entryY2 = CTk.CTkEntry(self, placeholder_text="Y image")
...
"SMOOTH_MORE"], variable=self.optionmenu_var)
        ...
        self.button4 = CTk.CTkButton(self, text="paste", command=paste)
        ...
        self.entrySave = CTk.CTkEntry(self, placeholder_text="name for image")
